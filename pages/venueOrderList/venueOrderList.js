...
Page({
  ...
  loadNumber: function () {
    var that = this;
    var url = app.api.TroupeOrderManageQueryApplyBookStatusNumInfo;
    var params = {
  ...
  getOrderList: function (params, cb) {
    var that = this;
    var url = app.api.TroupeOrderManageQueryScheduleBookingInfo;
  ...
  dataFormat: function () {
    ...
    dataList.forEach(d => {
      ...
      // 类型
      // let ShowTypes = d.TheatreVenueOutline.ShowTypes
      // let showTypeArr = []
      // ShowTypes.forEach(s => {
      ...
      // 剧目档期时间格式化
      d.ItemScheduleBeginTimeStr = app.util.formatDate(new Date(d.ItemScheduleBeginTime.replace(/-/g, '/')), 'yyyy.MM.dd')
      d.ItemScheduleEndTimeStr = app.util.formatDate(new Date(d.ItemScheduleEndTime.replace(/-/g, '/')), 'yyyy.MM.dd')
  ...
  openSubmitFlow: function (e) {
    ...
    result.ApplyName = that.data.currentItem.TheatreVenueOutline.VenueName + '预约单'
    
    result.ShowTroupeId = that.data.currentItem.TroupeId
    result.ShowTroupeName = that.data.currentItem.TroupeName
    result.ShowItemId = that.data.currentItem.ItemId
    result.ShowItemName = that.data.currentItem.ItemName
    
    result.PartyABeginDatetime = that.data.currentItem.ItemScheduleBeginTime
    result.PartyAEndDatetime = that.data.currentItem.ItemScheduleEndTime
    result.AdditionalPrice = Number(that.data.currentItem.AdditionalPrice || 0)
    result.TheatreId = that.data.currentItem.TheatreId
    result.TheatreVenueId = that.data.currentItem.TheatreVenueOutline.VenueId
  ...
  submitFlow: function (result) {
    ...
    let url = app.api.submitTheatreVenueScheduleBookingScheduleBookingMiddle
    wx.showNavigationBarLoading()
  ...
  submitPayFlow: function (result) {
    let that = this
    let params = this.getCommonParam(result)
    let url = app.api.TroupeOrderManagePay
    wx.showNavigationBarLoading()
    app.util.postData.call(that, url, params, 'POST',
      function (res) {
        console.log(res)
  ...
  unSubmitCancel(params) {
    let that = this
    let url = app.api.TroupeOrderManageUnSubmitCancel
    wx.showNavigationBarLoading()
    app.util.postData.call(that, url, params, 'POST',
      function (res) {
        console.log(res)
  ...
  cancelWhenWaitAboutReview(params) {
    let that = this
    let url = app.api.TroupeOrderManageCancelWhenWaitAboutReview
    wx.showNavigationBarLoading()
    app.util.postData.call(that, url, params, 'POST',
      function (res) {
        console.log(res)
  ...
  cancelWhenWaitAboutReview(params) {
    let that = this
    let url = app.api.TroupeOrderManageCancelWhenWaitPay
    wx.showNavigationBarLoading()
    app.util.postData.call(that, url, params, 'POST',
      function (res) {
        console.log(res)
  ...
  cancelWhenSuccessAboutReview(params) {
    let that = this
    let url = app.api.TroupeOrderManageCancelWhenSuccess
    wx.showNavigationBarLoading()
    app.util.postData.call(that, url, params, 'POST',
      function (res) {
        console.log(res)
